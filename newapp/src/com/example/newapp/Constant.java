...
public class Constant {
	...
	public final static int NET_WIFI= 4005;
	public final static int NET_MOBILE=4006;
	...
	public final static String ROOT_URL="http://localhost:9000/PhoneService";
	public final static String LOGIN=ROOT_URL+"/login";
	public final static String REGISTER=ROOT_URL+"/register";
	public final static String JOURNEYLIST=ROOT_URL+"/journeyList";
	public final static String VIDEOLIST=ROOT_URL+"/videoList";
	public final static String CHECK_PHONE=ROOT_URL+"/checkphone";
